...
We then remove the first and last few seconds of the data from each conversation
and concatenate all conversations' movement data into a single file.

```{r preprocess-concatenate-data, warning = FALSE, error = FALSE, message = FALSE, eval = TRUE}
...
```{r plot-conversation-summary-stats, echo=FALSE, warning = FALSE, error = FALSE, message = FALSE, eval = TRUE}
...
```{r recurrence-prelims, warning = FALSE, error = FALSE, message = FALSE, eval = TRUE}
...
```{r crqa-parameters, echo = FALSE, warning = FALSE, error = FALSE, message = FALSE, eval = TRUE}
...
```{r ready-for-crqa-drps, eval = TRUE}
...
```{r run-crqa-using-parameters, eval = TRUE}
...
```{r merge-recurrence-datasets, eval = TRUE}
...
```{r prep-data-prep, warning=FALSE, error=FALSE, message=FALSE, eval = TRUE}
...
```{r create-polynomials, eval = TRUE}
...
```{r plot-three-way-interaction, echo = FALSE, warning = FALSE, error = FALSE, message = FALSE, eval = TRUE}
