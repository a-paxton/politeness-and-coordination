...
prof_search_df = suppressMessages(
  read_csv('./data/crqa_parameters/crqa-radius_search-prof.csv')
) %>%
...
chosen_radius = prof_search_df$radius
chosen_delay = prof_search_df$ami.selected
chosen_embed = prof_search_df$embed.selected
current_participant = prof_search_df$participant_id
current_task = prof_search_df$task
